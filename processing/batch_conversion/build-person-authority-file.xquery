            ...
            <listPerson>
{
    ...
    let $allpeople as element()* := (
        ...
        for $p in $collection//(tei:author|tei:editor|tei:persName)[not(ancestor::author or ancestor::editor or ancestor::tei:revisionDesc or ancestor::tei:respStmt)]
            (: In Georgian, there are alternate versions of authors and editors marked up as child 
               persName elements. perName elements can also exist on their own. :)
